...
public class RoomBookingController {
    ...
    public ResponseEntity<RoomBooking> saveRoomBooking(@RequestBody RoomBooking roomBooking) throws AgenciaException {
        ...
        if (user == null || !user.getId().equals(roomBooking.getUser().getId()) ||
                room == null || !room.getId().equals(roomBooking.getRoom().getId()) || !room.getHotel().getId().equals(roomBooking.getHotelId()) ||
    ...
    public ResponseEntity<RoomBooking> editRoombooking (@PathVariable Long id, @RequestBody RoomBooking roomBookingEdit) throws AgenciaException {
        ...
        if (roomBooking == null || roomBooking.getDeleted()) {
            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
        } else if (user == null || !user.getId().equals(roomBookingEdit.getUser().getId()) ||
                room == null || !room.getId().equals(roomBookingEdit.getRoom().getId()) || !room.getHotel().getId().equals(roomBookingEdit.getHotelId()) ||
